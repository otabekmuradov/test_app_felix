...
class $AssetsLocaleGen {
  ...
  /// File path: assets/locale/es.json
  String get es => 'assets/locale/es.json';
  ...
  /// List of all assets
  List<String> get values => [en, es, ru, uz];
}

class $AssetsPngGen {
  const $AssetsPngGen();

  /// File path: assets/png/pngsignup.png
  AssetGenImage get pngsignup =>
      const AssetGenImage('assets/png/pngsignup.png');

  /// List of all assets
  List<AssetGenImage> get values => [pngsignup];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/arrow-narrow-right.svg
  SvgGenImage get arrowNarrowRight =>
      const SvgGenImage('assets/svg/arrow-narrow-right.svg');
  ...
  SvgGenImage get x => const SvgGenImage('assets/svg/x.svg');

  /// List of all assets
  List<SvgGenImage> get values => [logo, arrowNarrowRight, arrowRight, x];
}
